...
parser.add_argument("--min_coverage", dest="min_coverage", default=0.85, type=float, help="a minimum read coverage [0,1] (default: 0.8)", required=False)
parser.add_argument("--min_identity", dest="min_identity", default=0.85, type=float, help="a minimum alignement identity [0,1] (default: 0.9)", required=False)
